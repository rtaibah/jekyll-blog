...
directory = '/home/rami/projects/jekyll-blog/assets/images/content/lifestream/tbd/'
picfiles = glob.glob(r'/home/rami/projects/jekyll-blog/assets/images/content/lifestream/tbd/*/*/*/*.png')
...
for file in file_list:
    new_filename = re.search('(?<=tbd\/).+?(?=\/)',file).group(0)+'-'+str(counter)+'.png'
