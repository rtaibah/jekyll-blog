...
![Ubuntu Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/ubuntulogo.png)\*\* \*\*\*\*1-Ubuntu  
...
![pclinuxos.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/pclinuxos.png)**2-PCLinuxOS**

Pretty much obvious, 3 words jammed up into one, PC + Linux + Operating System.[PCLinuxOS](http://www.pclinuxos.com "PCLinuxOS") has a GUI that resembles Windows, in an effort to make switching to Linux easier. Hence the use of the word PC (even though PC is not exclusive to Windows, which is a misnomer Was named after the [pclinuxonline website and forums ](http://pclosmag.com/html/Issues/200709/page01.html)(Thanks subgeniusd and bob l)

  
![opensuse_logo.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/opensuse_logo.png)

**3-op****enSUSE**

[openSUSE](http://www.opensuse.org) is the SUSE community project sponsored by Novell and AMD. SUSE is an German acronym for "**S**oftware- **u**nd**S**ystem-**E**ntwicklung" ("Software and system development"). However some claim that it's a tribute the computer engineer [Konrad **Zuse**](http://en.wikipedia.org/wiki/Konrad_Zuse "Konrad Zuse")**.**
...
![Fedora Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/fedora.jpg)
...
![mandriva_linux.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/mandriva_linux.png)**5-Mandriva**

This Linux distro was the original Mandrake Linux distro, which was maintained by MandrakeSoft, however MandrakeSoft lost a legal battle against [Hearst Corporation](http://en.wikipedia.org/wiki/Hearst_Corporation "Hearst Corporation") over the name "Mandrake". MandrakeSoft later on bought [Connectiva](http://en.wikipedia.org/wiki/Conectiva "Connectiva"), the result of the fusion = [Mandriva](http://www.mandriva.com "Mandriva") ![:)](http://192.168.1.2/blog2/wp-includes/images/smilies/icon_smile.gif)

  
![Sabayon Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/sabayon.png)**6-Sabayon**

[Sabayon](http://www.sabayonlinux.org "Sabayon") is a distro produced in Trentino, Italy and is named after an Italian dessert also called [Sabayon](http://en.wikipedia.org/wiki/Zabaglione "Sabayon"). Sabayon (or Zabaglione) is made of egg yolks, sugar, and sweet liquor.

  
![debian_linux.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/debian_linux.png)
...
![damnsmall.jpg](http://192.168.1.33/blog2/wp-content/uploads/2008/04/damnsmall.jpg)

**8-Damn Small Linux**

[Damn Small Linux](http://www.damnsmalllinux.org/ "Damn Small Linux") is a very small Linux distro with the size of only 50 MB. Hence the name. Like Duuuuh ![:P](http://192.168.1.2/blog2/wp-includes/images/smilies/icon_razz.gif)

-

  
![mepis.jpg](http://192.168.1.33/blog2/wp-content/uploads/2008/04/mepis.jpg)
...
![FreeBSD Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/freebsd_full.png)**10-FreeBSD**
...
![centos.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/centos.png)
...
![DreamLinux Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/dreamlinux.png)**12-Dreamlinux**
...
![puppy_linux.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/puppy_linux.png)**13-Puppy Linux**
...
**![Zenwalk Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/zenwalk2.png)******
...
![Slackware logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/slackware.jpg)
...
![knoppix.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/knoppix.png)
...
![Gentoo Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/gentoo.png)**17-Gentoo**
...
![slax.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/slax.png)
...
![sidux.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/sidux.png)

**19-Sidux**

[Sidux](http://sidux.com/index.html "Sidux") is a Linux distro based on the unstable branch of Debian which is codenamed "Sid", which in turn is named after the [Sid Phillips](http://en.wikipedia.org/wiki/Sid_Phillips "Sid Phillips") character in [Toy Story](http://en.wikipedia.org/wiki/Toy_Story "Toy Story") -- usually destroys and tortures his sister Hannah's toys. You see, geeks do have a sense of humor ![;)](http://192.168.1.2/blog2/wp-includes/images/smilies/icon_wink.gif)  
**  
**

![Ubuntu Studio Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/ubuntu_studio_final_logo.png)
...
![pc-bsd.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/pc-bsd.png)
...
![Xubuntu Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/xubuntu1.png)  
**22-Xubuntu**
...
![Foresight Linux Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/foresight3.jpg)**23-Foresight**

[Foresight](http://www.foresightlinux.org/ "Foresight") is a Linux distro that uses [Conary](http://wiki.rpath.com/wiki/Conary "conary") as a package manager, it allows rolling updates, rather than the 2 big releases a year most distros do. For example, when banshee 1.0 comes out next month Foresight users will have it in less than a week, while Ubuntu users will wait until October (Thanks to pcutler from the forsight IRC channel for explaining this). Anyways, with Conary, [Forsight](http://www.foresightlinux.org/ "Forsight") in a sense gets software you otherwise will have to wait for in other distros, pretty neat ![;)](http://192.168.1.2/blog2/wp-includes/images/smilies/icon_wink.gif)

![DesktopBSD Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/desktopbsd1.png)**24-DesktopBSD**
...
![redhat-copy.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/redhat-copy.png)**25-Red Hat**

This one has some really interesting stories behind it, I'll leave the floor to Red Hat co-founder Bob Young to explain:

  
![OpenGEU Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/opengeu1.png)
...
![elive.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/elive.png)  
**27-Elive**
...
![Freespire Logo](http://192.168.1.33/blog2/wp-content/uploads/2008/04/freespire2.png)**28-Freespire**
...
![Frugalware Linux](http://192.168.1.33/blog2/wp-content/uploads/2008/04/frugalware2.png)**29-Frugalware**  
...
![fluxbuntu.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/fluxbuntu.png)
...
![xandrosos2.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/xandrosos2.png)**31-Xandros**  
[Xandros](/blog/wp-admin/http:/www.xandros.com "Xandros")'s name is derived from the X Window system and the Greek island [Andros](http://en.wikipedia.org/wiki/Andros "Andros"). _Edit: Mike Bego, one of the founders of Xandros, commented below and after a couple of E-mails we arrived to this conclusion: Will Roseman (co-founder) chose Andros island because he thought __of Andros in the mythological context relating to "Isle __of Man". Isle of Man was, according to one legend, where man was born. So the Andros part would be where desktop Linux was born.__Mike also denied that t__he distro was named after the X Window System, he added the X just because it___improved the sound / image of the name_._
...
![tinyme.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/tinyme.png)
...
![gos.jpg](http://192.168.1.33/blog2/wp-content/uploads/2008/04/gos.jpg)
...
![backtrack.png](http://192.168.1.33/blog2/wp-content/uploads/2008/04/backtrack.png)
...
![Mint Linux](http://192.168.1.33/blog2/wp-content/uploads/2008/04/mint-linux.png)**35-Mint Linux**
